...
const Cart = () => {
  ...
  const shipping = 4.0; // Fixed shipping cost
  const tax = subtotal * 0.1; // Assume 10% tax rate
  const total = subtotal + shipping + tax;

  return (
    <section>
      <div className="mt-3 flex flex-col items-center border-b bg-white mb-10 sm:flex-row xl:px-32">
        <Link to="/" className="text-2xl font-bold text-gray-800">
          Home 🔙 🔙
        </Link>
        <div className="mt-2 mb-5 text-xs sm:mt-2 sm:ml-auto sm:text-base">
          <div className="relative">
            <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
              <li className="flex items-center space-x-3 text-left sm:space-x-4">
                <Link
              ...
              <IoMdArrowForward className="h-4 w-4 font-bold text-gray-900" />
              <li className="flex items-center space-x-3 text-left sm:space-x-4">
                <Link
                  to="#"
              ...
              <IoMdArrowForward className="h-4 w-4 text-gray-400" />
              <li className="flex items-center space-x-3 text-left sm:space-x-4">
                <Link
                  to="#"
                  className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-400 text-xs font-semibold text-white"
      ...
      <div className="cart">
        ...
        <div>
          <div className="bg-gradient-to-tl mt-7 from-[#B0EBB4] via-[#BFF6C3] to-[#E0FBE2] p-6 lg:sticky top-0">

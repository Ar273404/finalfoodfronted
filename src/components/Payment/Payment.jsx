      ...
      <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
        <div className="flex flex-col rounded-lg bg-white sm:flex-row">
          ...
          <div className="flex w-full flex-col px-4 py-4">
            ...
            <p className="text-lg font-bold"><span>&#8377;</span>138.99</p>
          </div>
        </div>
        <div className="flex flex-col rounded-lg bg-white sm:flex-row">
          ...
          <div className="flex w-full flex-col px-4 py-4">
            <span className="font-semibold">Nike Air Max Pro 8888 - Super Light</span>
            <span className="float-right text-gray-400">42EU - 8.5US</span>
            <p className="mt-auto text-lg font-bold"><span>&#8377;</span>238.99</p>
          </div>
        </div>
      </div>
      ...
      <div className>
        ...
        <div className="mt-6 border-t border-b py-2">
          <div className="flex items-center justify-between">
            ...
            <p className="font-semibold text-gray-900"><span>&#8377;</span>399.00</p>
          </div>
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-gray-900">Shipping</p>
            <p className="font-semibold text-gray-900"><span>&#8377;</span>8.00</p>
          </div>
        </div>
        <div className="mt-6 flex items-center justify-between">
          <p className="text-sm font-medium text-gray-900">Total</p>
          <p className="text-2xl font-semibold text-gray-900"><span>&#8377;</span>408.00</p>
        </div>
      </div>
      <Link to='/'>
